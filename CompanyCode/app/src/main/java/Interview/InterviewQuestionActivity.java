...
import com.q_a.companycode.Listitem_question;
import com.q_a.companycode.MyAdapter_Question;
...
public class InterviewQuestionActivity extends AppCompatActivity {
    ...
    public  static final String url ="https://compulsory-rug.000webhostapp.com/InterviewQuestion.php";
    int position;
    String companyName;
    TextView cn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companyName = InterviewActivity.listItems.get(position).getSubject();
