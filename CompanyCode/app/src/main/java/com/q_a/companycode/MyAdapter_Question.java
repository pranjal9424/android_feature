...
public class MyAdapter_Question extends ArrayAdapter<Listitem_question> {
    ...
    public MyAdapter_Question(List<Listitem_question> listItems,@NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listitem_question,null,true);
